...
class parereApp(object):
    ...
    def NuovoNumeroPratica(self, obj):
        ...
        query = dict(IOL_NUM_FIELD=dict(query=0, range='min'), iol_tipo_app='parere')
    ...
    def inviaSmtpMail(self,obj,ObjectId,to=[],cc=[],bcc=[]):
        ...
        iDoc = IolApp(doc)
        diz_mail = iDoc.getConvDataMail('mail_%s' %('parere'))
